...
public class PartnerRedemption extends BaseEntity implements TenantAware {
     ...
     *
     * <p>XTRM binds a user to whoever created them, and refuses a second user with the same email — so this
     * is permanent and cannot be corrected by re-enrolling. A company may only pay a seller whose PAT it
     * created itself; the platform may pay any of them, which is why personal redemption is unaffected.</p>
     *
