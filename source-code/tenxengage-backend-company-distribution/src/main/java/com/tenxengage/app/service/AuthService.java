...
public class AuthService {
    ...
    public AuthResult login(LoginRequest request) {
        ...
        try {
            ...
            // CustomUserDetails.isEnabled() returns false for non-ACTIVE users; Spring Security
            // throws DisabledException before we can check status ourselves. Re-check the user
            // status here so the right domain message is emitted.
