...
public class RewardTransactionController {
    ...
    public ResponseEntity<PaginatedResponse<RewardTransactionResponse>> getMyTransactions(
    ...
    public ResponseEntity<PaginatedResponse<RewardTransactionResponse>> getUserTransactions(
