...
public final class RedemptionRequestFixtures {
    ...
    public static RedemptionRequest.RedemptionRequestBuilder pendingApproval(
            UUID clientId, UUID userId, UUID walletId, UUID catalogItemId) {
        return defaultPersonal(clientId, userId, walletId, catalogItemId)
                .status(RedemptionStatus.PENDING_APPROVAL);
    }

    public static RedemptionRequest.RedemptionRequestBuilder withReviewedBy(
            UUID clientId, UUID userId, UUID walletId, UUID catalogItemId, UUID reviewedBy) {
        return defaultPersonal(clientId, userId, walletId, catalogItemId)
                .reviewedBy(reviewedBy)
                .reviewedAt(Instant.now());
    }

    public static RedemptionRequest.RedemptionRequestBuilder withRejectionReason(
            UUID clientId, UUID userId, UUID walletId, UUID catalogItemId, String reason) {
        return defaultPersonal(clientId, userId, walletId, catalogItemId)
