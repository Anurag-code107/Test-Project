...
class RedemptionCatalogControllerTest {
    ...
    private CatalogBrowseItemResponse sampleBrowseItem() {
        return new CatalogBrowseItemResponse(
                ITEM_ID, "Amazon Gift Card", "Description", null, null, RedemptionCategory.NON_CASH,
                "USD", new BigDecimal("5.00"), "VARIABLE", new BigDecimal("500.00"),
                RedemptionProcessingMode.INSTANT,
