...
export default function TransactionHistoryPage() {
  ...
  // Personal, plus My Returns when the user may raise a return.
  return (
    <div className="flex flex-col h-full animate-route-in" aria-label="Main content">
      <div className="shrink-0 mb-6">
        <PageBanner
          ...
          subtitle="A log of your reward redemptions"
        />
      </div>

      <Tabs defaultValue="personal" aria-label="Redemption history tabs" className="flex flex-col flex-1 min-h-0">
