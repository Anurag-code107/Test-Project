...
// COMPANY removed with company-wallet redemption (design §12.3). Historical export job rows may
// still carry the string, so widen only if such a row is ever rendered.
export type ExportJobScope = 'PERSONAL' | 'ALL_TENANT';
