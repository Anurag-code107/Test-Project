  ...
  "findings": [
    {
      ...
      "line": 42,
      "rule": "sql-injection|xss|csrf|auth|secrets|input-validation|logging|deserialization|dependency",
      "message": "Brief description of the vulnerability or issue",
      "suggestion": "How to fix it",
      "autoFixable": true
    }
  ],
  "filesReviewed": ["path/to/File.java"],
  "summary": "N security issue(s) found across M file(s)"
}
```
