...
| AuditAction | Specific event recorded in an audit log entry (CREATED / EDITED / ACTIVATED / LOGGED_IN) | 17 | enums.md §AuditAction |
| AuditActorType | Whether an audit action was performed by a human user or the system (USER / SYSTEM) | 2 | enums.md §AuditActorType |
| AuditResourceType | Entity type that an audit log entry refers to (INCENTIVE / USER / CONNECTOR / CLIENT / BALANCE_EXPIRATION_POLICY) | 24 | enums.md §AuditResourceType |
