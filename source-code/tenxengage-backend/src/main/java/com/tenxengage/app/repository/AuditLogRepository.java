...
public interface AuditLogRepository extends JpaRepository<AuditLog, UUID> {
    ...
    @Query("""
        ...
        WHERE a.clientId = :clientId
          AND (CAST(:userType AS STRING) IS NULL OR a.userType = :userType)
    ...
    List<AuditLog> findByActorIdAndResourceType(UUID actorId, AuditResourceType resourceType);

    long countByClientIdAndResourceType(UUID clientId, AuditResourceType resourceType);
