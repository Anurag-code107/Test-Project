...
public class ClientCatalogItemConfig extends BaseEntity implements TenantAware {
    ...
    /** Client ceiling. Null = inherit the item's defaultMaxRedemptionAmount (null there = no ceiling). */
    @Column(name = "max_transaction_amount_override", precision = 18, scale = 2)
    private BigDecimal maxTransactionAmountOverride;
