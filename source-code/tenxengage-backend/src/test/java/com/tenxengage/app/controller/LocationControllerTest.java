...
class LocationControllerTest {
    ...
    @Test
    void getLocations_returns401ForUnauthenticated() throws Exception {
        mockMvc.perform(get("/api/v1/location-levels")).andExpect(status().isUnauthorized());
    }

    @Test
    @WithMockUser(roles = "CLIENT_ADMIN")
    void getLocations_returns200ForClientAdmin() throws Exception {
        mockMvc.perform(get("/api/v1/location-levels")).andExpect(status().isOk());
    }
}
