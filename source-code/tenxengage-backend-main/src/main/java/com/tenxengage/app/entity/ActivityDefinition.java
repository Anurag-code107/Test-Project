...
public class ActivityDefinition extends BaseEntity {
    ...
    @OneToMany(mappedBy = "activityDefinition", cascade = CascadeType.ALL, orphanRemoval = true)
    @Builder.Default
    private List<ActivityDocumentRequirement> requiredDocuments = new ArrayList<>();
}
