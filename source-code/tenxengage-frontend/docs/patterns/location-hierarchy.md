...
> **Cross-ref:** For the blueprint-level pattern (spec authoring guidance, backend service contracts),
> see [tenxengage-blueprint/docs/patterns/location-hierarchy.md](../../../tenxengage-blueprint/docs/patterns/location-hierarchy.md).
> This file covers frontend TypeScript shapes, hooks, and component integration.
