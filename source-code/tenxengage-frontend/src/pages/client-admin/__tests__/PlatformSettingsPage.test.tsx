...
vi.mock("@/components/settings/RedemptionCatalogTab", () => ({
  RedemptionCatalogTab: () => <div>RedemptionCatalogTab Content</div>,
}));
...
describe("PlatformSettingsPage feature flag gating", () => {
  it("renders Integrations tab + content when api_access is enabled", () => {
    ...
    render(<MemoryRouter><PlatformSettingsPage /></MemoryRouter>);
