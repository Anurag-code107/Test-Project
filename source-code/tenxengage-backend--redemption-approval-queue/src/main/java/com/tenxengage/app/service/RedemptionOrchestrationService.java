...
public class RedemptionOrchestrationService {
    ...
    // STUB injections — both vendor services are stubs until credentials are confirmed working.
    // Remove these comments when US-05 BE-1 (XTRM) and US-06 BE-1 (Xoxoday) are fully implemented.
     ...
     * Routing logic is final. The vendor services underneath are stubs until credentials
     * are available — see XtrmVendorService (US-05 BE-1) and XoxodayVendorService (US-06 BE-1).
     */
