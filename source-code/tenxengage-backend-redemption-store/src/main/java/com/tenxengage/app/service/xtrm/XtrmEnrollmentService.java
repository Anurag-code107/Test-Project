...
public class XtrmEnrollmentService {
     ...
     * Callers must gate this to payee roles (the profile endpoint's redeem/redeem_company permission does).
     */
    ...
    void enrollIfNeeded(User user) {
        ...
        try {
            result = xtrmApiClient.createUser(new CreateUserCommand(
                    ...
                    addr.getRegion(), addr.getPostalCode(), addr.getCountryIso2()));
